# Julia
I'm a casual; I'm here out of curiosity.

- [The Julia Programming Language](https://julialang.org) - The official site.
  - [Getting Started: The Julia Language](https://docs.julialang.org/en/v1/manual/getting-started/).
  - [Pkg, the package manager - documentation](https://docs.julialang.org/en/v1/stdlib/Pkg/).
...
- [RemoteREPL.jl](https://github.com/JuliaWeb/RemoteREPL.jl) (Github, Julia package) - "Connect a REPL to a remote Julia process."
- [Think Julia: How to Think Like a Computer Scientist](https://benlauwens.github.io/ThinkJulia.jl/latest/book.html). Freely available online; also [available for purchase in print](http://www.jdoqocy.com/click-9038105-11290546?url=http%3A%2F%2Fshop.oreilly.com%2Fproduct%2F0636920215707.do%3Fcmp%3Daf-strata-books-video-product_cj_0636920215707_%25zp&cjsku=0636920215707).

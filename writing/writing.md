...
- Claire Taylor. *Write Iconic Characters: Unlocking the Core Motivations That Fuel Unforgettable Stories*. I approached this hesitantly because I've never been able to make a ton of sense of Enneagram, but *enough* is explained to orient the reader toward Enneagram concepts that there are parts of this I find useful in understanding character archetypes and motivations *as a starting point*s. **Recommended**.
- Paul Tomlinson. *Character Creation: A Guide to Archetypes, Motivation and Emotion for Writers and Actors*. Idiosyncratic stylized/dramatized Jungian approach, particularly Jungian archetypes and shadows + animus/anima. Also the only characterization book that works wholesale *for me*. I don't claim it works for anyone else. **Recommended** (*see* caveats).
  - 1 Inner Conflict
  - 2 Shadow and Denied Self
  - 3 The Character Palette - Introduction
  - 4 Themes and Values
  - 5 Motivation
  - (more TK)
...
# Genre: Memoir
- Lindsey Grant. *Ready, Set, Memoir!* I'm not in memoirs at all so I can't vouch for this one way or another except as a fun inspirational book to browse.
...
# Screenwriting
Please note that I'm not a screenwriter so I cannot comment from that standpoint; I'm usually taking techniques into *prose novels*.

- William Rabkin. *Writing the Pilot*. Extremely specific to the exigencies of TV pilots. Absolutely has lessons that can be carried into other formats but there are considerations that wholesale won't apply outside that realm. **Recommended** with caveats depending on use case.
- David Trottier. *The Screenwriter's Bible: A Complete Guide to Writing, Formatting, and Selling Your Script*, 7th ed., expanded and updated. Thanks to Rebecca Roanhorse. **Recommended**.

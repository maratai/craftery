...
# Environment Design
- Mike W. Lin, ASLA. *Drawing and Designing with Confidence: A Step-By-Step Guide*.
...
- Rockhe Kim. *Rockhe Kim's Line Drawing Technique vol. 1*. Oriented toward comic (etc) lineart for figures.
- Taco. (Apparently the artist-writer's handle, Korean?) *Point Character Drawing 1* and *Point Character Drawing 2*. Pocket-sized and excellent quick reference.
- ???. *Morbid Anatomy vol. 1: An Image Archive for Artists and Designers*. This is, bluntly, flayed/tortured/injured/medical image reference form public domain for those of us who want art reference for horror, violence, medical damage but would...rather not pursue photographic examples. (I can handle medical grue but otherwise I'm squeamish.) **Recommended** for the specific use case.
